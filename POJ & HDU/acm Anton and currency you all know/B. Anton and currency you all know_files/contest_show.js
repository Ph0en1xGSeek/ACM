...
var showpfunc=function(gcpid) {
    ...
    $("#contest_content").html('<div class="tcenter"><img src="img/ajax-loader.gif" />Loading...</div>');
    return false;
}
...
function updaterank(passtime,isadmin) {
    ...
    $.get(("contest_standing.php?"+(isadmin?"admin=1&":"")+"randomid=")+Math.random()+extstr+"&"+$("#csetform").serialize() ,function(data){
        ...
        $(".cha_click").click(function() {
            ...
            $("#chasrcimage").attr("src","img/ajax-loader.gif");
            $("#cchahistory").html("");
            $("#cchadetailcontent").html('<img height="15px" src="img/ajax-loader.gif" />Loading....');
            $("#cchadetail").hide();
...
var clarfunc=function(data) {
    ...
    $("#newquestion").click(function() { $("#questiondialog").modal("show"); return false; });
    document.title=$("#contest_content .pagetitle").text();
    $("#contest_nav li").removeAttr("disabled").removeClass("disabled");
}
...
$(document).ready(function() {
    ...
    $("#cchaform").submit(function() {
        ...
        $("#chamsgbox").removeClass().addClass('normalmessagebox').html('<img height="15px" src="img/ajax-loader.gif" />Validating....').fadeIn(500);
